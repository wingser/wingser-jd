...
export QYWX_AM="wwfdb9e93224cff988,NWr1UYyKxv81psObfOqItc8u8OI5xuLLXdlpRziFmJI,ZhangYi01|aShenYangCheWuWeiZhangChaXun|DingDaYe|LiXiaoDong|SunBin|ZhenXiYanQianRen,1000002,2C14YzCXQnTXQlD_E7bY_5e_IJ7tVNmC5hlA3wJ5ob8PxGd2kGT_buyC7Z_96bUuf"
export QYWX_AM_BD="wwfdb9e93224cff988,NWr1UYyKxv81psObfOqItc8u8OI5xuLLXdlpRziFmJI,ZhangYi,1000002,27ZhbL8rL6nKhLxltckWR3Z14rcs2uUUDQDNynco9INX_ognFbEwp8MKWjTFC7S2d"
...
export OPEN_DREAMFACTORY_TUAN="1,2,3,4,5,6,7"
...
export NOTIFY_SKIP_LIST="京东试用&省钱大赢家之翻翻乐&取关所有主播&京东多合一签到&领京豆&京东签到图形验证&愤怒的锦鲤&京东保价&超级直播间红包雨&东东乐园&农场集勋章&东东农场_内部互助&东东萌宠_内部互助&京东到家果园互助码:&京喜农场"
...
export BEANCHANGE_PERSENT="20" ##10合1
...
export RUSH="true"
export JDDJ_CKPATH="/ql/scripts/shufflewzc_faker3/jddjCookie.js"
export gua_wealth_island_codeId="1,2,3"
export BYTYPE="999" #惊喜牧场自动购买小鸡

# wingser 自用变量
export NOTIFY_CONFIG_PATH="/ql/config/notify.toml" #签到面板通知
export NOTIFY_SKIP_LIST_WINGSER="李美&崔安&小崔老婆&孙彬&丁松&jd_4ae4fab016bc1&jd139403poi"  #通知过滤用户。
export kois="ningnzhang"
export exjxbeans="true"
export guaopencard76="true"
export FS_LEVEL="car"
